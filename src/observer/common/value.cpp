...
float Value::get_float() const
{
	...
	case AttrType::DATES: {
		LOG_WARN("Cannot convert date to float.");
		return 0.0;
	}break;
	case AttrType::BOOLEANS: {
...
int Value::get_date() const
{
	...
	case AttrType::FLOATS: {
		LOG_WARN("Cannot convert float to date");
	}break;
	case AttrType::BOOLEANS: {
		LOG_WARN("Cannot convert boolean to date");
	}break;
	case AttrType::INTS: {
		return value_.int_value_;
	}break;
...
bool Value::get_boolean() const
{
	...
	case AttrType::DATES: {
		LOG_WARN("Cannot convert date to boolean");
	}break;
	default: {
		LOG_WARN("unknown data type. type=%d", attr_type_);
		return false;
