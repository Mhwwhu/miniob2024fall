...
public:
	 ...
	 */
	virtual IndexScanner* create_scanner(vector<pair<const char*, int>> left_keys, vector<bool> left_inclusive,
		vector<pair<const char*, int>> right_keys, vector<bool> right_inclusive) = 0;
